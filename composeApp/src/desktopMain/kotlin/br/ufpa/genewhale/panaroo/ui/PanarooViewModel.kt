...
import br.ufpa.genewhale.panaroo.params.PanarooParamsConfig
import br.ufpa.genewhale.panaroo.services.PanarooService
import br.ufpa.genewhale.panaroo.services.PanarooUsages
...
class PanarooViewModel(
    ...
    private fun loadConfig() {
        runBlocking {
            val panaroo =
                br.ufpa.genewhale.utils.Config.load<PanarooParamsConfig>(br.ufpa.genewhale.utils.Config.PANAROO_CONFIG_FILE)
            panaroo?.let { data ->
    ...
    private fun config(intent: PanarooParamsIntent) {
        if (intent is PanarooParamsIntent.Save) {
            viewModelScope.launch {
                br.ufpa.genewhale.utils.Config.save(
                    name = br.ufpa.genewhale.utils.Config.PANAROO_CONFIG_FILE,
