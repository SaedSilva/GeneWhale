...
import br.ufpa.genewhale.uicomponents.Terminal
import br.ufpa.genewhale.uicomponents.ToolScreen
import br.ufpa.genewhale.uicomponents.buttons.MyButton
import br.ufpa.genewhale.uicomponents.buttons.MyOutlinedButton
import br.ufpa.genewhale.uicomponents.pickfiles.PickFolder
                ...
                OutlinedCard(
                    ...
                    Column(
                        ...
                        PickFolder(
                            ...
                            onClickButton = { onIntent(PanarooUiIntent.ClickPickFolder) },
                            onResult = { onIntent(PanarooUiIntent.ChangeInputFolder(it?.path)) }
                        )
                        ...
                        PickFolder(
                            ...
                            onClickButton = { onIntent(PanarooUiIntent.ClickPickFolder) },
                            onResult = { onIntent(PanarooUiIntent.ChangeOutputFolder(it?.path)) }
                        )
                    }
                }
