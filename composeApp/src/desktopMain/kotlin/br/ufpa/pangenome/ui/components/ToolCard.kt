...
import pangenome.composeapp.generated.resources.no_logo
import pangenome.composeapp.generated.resources.panaroo
import pangenome.composeapp.generated.resources.ppanggolin

@Composable
fun ToolCard(modifier: Modifier = Modifier, tools: Tools, onClick: () -> Unit) {
    val scrollState = rememberScrollState()

    Card(modifier.width(256.dp).height(300.dp)) {
        Column(
